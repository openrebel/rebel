...
class Settings extends Tabs {
    constructor(args) {
        ...
        this.tabAbout   = this.AddTab("About", "res/logo.svg");
    ...
    ShowAbout() {
        ...
        opensource.innerHTML = "Rebel is a free and open-source tool developed and maintained by Andreas Venizelou.<br>All of the source code to this product is available to you under the GNU General Public License. That means you may use, copy, distribute, and modify the source code to meet your needs.";
        ...
        credits.innerHTML = "Some of Rebels tools use external code and make use of the following libraries:<br>";
        ...
        involve.href = "https://github.com/veniware/OpenRebel";
        ...
        const icons = ["res/logo.svg", "res/copyleft.svg", "res/opensource.svg","res/gpl.svg", "res/github.svg"];
